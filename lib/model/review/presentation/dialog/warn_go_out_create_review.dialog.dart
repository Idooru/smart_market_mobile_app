...
class WarnGoOutCreateReviewDialog {
  static void show(BuildContext context, {String? backRoute}) {
    showDialog(
      context: context,
      builder: (BuildContext context) => Dialog(
        child: WarnGoOutCreateReviewDialogWidget(
          backRoute: backRoute,
        ),
      ),
    );
...
class WarnGoOutCreateReviewDialogWidget extends StatelessWidget {
  final String? backRoute;

  const WarnGoOutCreateReviewDialogWidget({
    super.key,
    this.backRoute,
  });
